    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 border-t border-gray-100 pt-8">
        <div class="sm:flex sm:justify-between">
          <p class="text-xs text-gray-500">&copy; {{ (new Date()).getFullYear() }}. Cupcake Store. Todos os direitos reservados.</p>

          <ul class="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
            <li>
              <a href="#" class="text-gray-500 transition hover:opacity-75"> Termos e condições </a>
            </li>

            <li>
              <a href="#" class="text-gray-500 transition hover:opacity-75"> Política de privacidade </a>
            </li>
